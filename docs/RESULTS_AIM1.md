...
length-matched coding-vs-intergenic control is not significant. After
residualizing the deltas against SV length/type plus repeat, mappability, and
gene-density covariates, the linear residualized signal collapses below chance.
...
| coding/splice vs intergenic, raw | 300 | 0.610 [0.548, 0.675] | 0.0020 | 0.990 | 0.263 | 0 | dominated by covariates |
| coding/splice vs intergenic, length-matched | 166 | 0.547 [0.480, 0.636] | 0.112 | 0.991 | 0.049 | 0 | null after adversarial control |
| cds vs intronic, length-matched | 124 | 0.362 [0.255, 0.455] | 0.518 | 0.830 | 0.174 | 0 | null |
| splice vs intergenic, length-matched | 106 | 0.522 [0.424, 0.627] | 0.014 | 0.975 | 0.044 | 0 | not credible beyond covariates |
| cds vs intergenic, length-matched | 132 | 0.432 [0.335, 0.570] | 0.234 | 0.995 | 0.014 | 0 | null |
...
0.547 with confidence interval crossing 0.5 and permutation p=0.112.
